...
public class LifeCycleDemoBean
    ...
    public LifeCycleDemoBean() {
        System.out.println("## I'm in the LifeCycleBeen Constructor");
    }
    ...
    public void destroy() throws Exception {
        System.out.println("## The LifeCycleBeen has been terminated");

    }

    @Override
    public void afterPropertiesSet() throws Exception {
        System.out.println("## The LifeCycleBeen has its properties set");
